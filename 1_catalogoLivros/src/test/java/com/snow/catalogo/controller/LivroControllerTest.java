...
class LivroControllerTest {
    ...
    void testSearchLivrosByAutor() throws Exception {
        List<Livro> livrosMock = Collections.singletonList(livro);
        Mockito.when(livroService.findLivrosByAutor("Machado de Assis")).thenReturn(livrosMock);
    ...
    void testSearchLivrosByTitulo() throws Exception {
        List<Livro> livrosMock = Collections.singletonList(livro);
        Mockito.when(livroService.findLivrosByTitulo("Dom Casmurro")).thenReturn(livrosMock);
